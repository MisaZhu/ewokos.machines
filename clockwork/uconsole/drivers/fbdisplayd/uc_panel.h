...
/*
 * ClockworkPi CM4 MIPI DSI panels.  The same fbdisplayd binary drives both:
 *
 ...
 * is a runtime switch keyed off the configured width: libfbdisplayd passes
 * /etc/display.json's width into init(), and width 480 selects
