 ...
 * This HAT needs no LCD-CS dance around the touch poll (kept as-is from
 * the original read-on-demand driver); a sample clobbered by a preempting
 * flush IPC is rejected by the clamp filter.
 */
