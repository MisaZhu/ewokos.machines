...
#define  JOYSTICK_A_PIN		GPIO_PIN(0,11)
#define  JOYSTICK_B_PIN		GPIO_PIN(0,9)
#define  JOYSTICK_X_PIN		GPIO_PIN(0,13)
#define  JOYSTICK_Y_PIN		GPIO_PIN(0,12)
#define  JOYSTICK_SELECT_PIN	GPIO_PIN(3,22)
#define  JOYSTICK_START_PIN	GPIO_PIN(3,27)
#define  JOYSTICK_L1_PIN		GPIO_PIN(0,8)
#define  JOYSTICK_R1_PIN		GPIO_PIN(1,9)
...
static void check_ux(void) {
	if(rockchip_gpio_get(JOYSTICK_L1_PIN) == 0){
		core_prev_ux();
	}
	
	if(rockchip_gpio_get(JOYSTICK_R1_PIN) == 0){
		core_next_ux();
	}
}
